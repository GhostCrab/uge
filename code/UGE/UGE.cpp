...
UGE::UGE(const wchar* cmdLine) : App(L"DX12 Memory Pool Test", cmdLine)
{
    minFeatureLevel = D3D_FEATURE_LEVEL_12_0;
}

void UGE::BeforeReset()
{
}
...
void UGE::DestroyPSOs()
{
    DX12::DeferredRelease(computeJobPSO);
}

void UGE::Update(const Timer& timer)
{
...
void UGE::Render(const Timer& timer)
{
...
void UGE::RenderHUD(const Timer& timer)
{
